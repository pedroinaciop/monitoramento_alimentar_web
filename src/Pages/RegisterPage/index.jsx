...
const RegisterUser = () => {
    ...
    const logOnSchema = z.object({
        nomeCompleto: z.string()
            ...
            .max(80, "O nome pode ter no máximo 60 caracteres"),

        email: z.string()
            .toLowerCase()
            .nonempty("O e-mail é obrigatório")
            .email('Formato de e-mail inválido')
            .max(120, "O e-mail não pode ser maior do que 120 caracteres"),

        senha: z.string()
            .nonempty("A senha não pode estar vazia")
            .min(4, "A senha precisa de no mínimo 4 caracteres")
            .max(30, "A senha não pode ultrapassar 30 caracteres"),
